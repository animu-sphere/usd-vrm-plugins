...
GetUsage()
{
    return "motion_bvh_inspect - report what a BVH file contains\n"
           "\n"
    ...
    *showHelp = false;
    for (std::size_t i = 0; i < arguments.size(); ++i)
    {
        ...
        else if (argument == "--")
        {
            ...
            {
                *error = "this tool reads one file at a time; '" + arguments[i] + "' is a second";
                return false;
            }
            ...
            {
                *error =
                    "this tool reads one file at a time; '" + arguments[i + 1] + "' is a second";
                return false;
            }
        }
        ...
        {
            *error = "this tool reads one file at a time; '" + argument + "' is a second";
            return false;
        }
    }
