...
`docs/design/fixtures/motion/avatar.usda`. The bake is what shows that a live
...
([motion-foundation-split.md §6](../../../../docs/roadmap/motion-foundation-split.md#6-mig-4--recording-and-live-input-)),
