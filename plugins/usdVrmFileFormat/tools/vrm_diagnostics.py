...
_VALIDATE_SPECS = [
    ...
    _spec("VRM223", Severity.ERROR, "validate",
          "Material API schema is applied to a prim that is not a Material"),
    _spec("VRM224", Severity.ERROR, "validate",
          "VrmTextureInfoAPI instance is not a texture role"),
    _spec("VRM225", Severity.ERROR, "validate",
          "Canonical material token is outside its documented set"),
    _spec("VRM226", Severity.ERROR, "validate",
          "VrmMToonAPI is applied but vrm:shaderModel is not 'MToon'"),
