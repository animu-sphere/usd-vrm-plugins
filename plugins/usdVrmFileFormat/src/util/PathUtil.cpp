...
std::string
_HashSuffix(const std::string& value)
{
...
bool
_IsIdentifierChar(unsigned char c)
{
...
VrmMakeUniqueNames(const std::vector<std::string>& sourceNames, const std::string& fallbackPrefix)
{
