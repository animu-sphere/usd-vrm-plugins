...
The committed test fixture `plugins/usdVrm/tests/fixtures/minimal.vrm` is
generated by `plugins/usdVrm/tools/generate_minimal_vrm.py` and contains no
third-party art; it is covered by this repository's Apache-2.0 license.
