...
| [`vrmAdapterVmc`](adapters/liveCapture/vmc) | Plain static CMake library | The first of those leaves: VMC Protocol input, from OSC-over-UDP datagrams to canonical humanoid semantics. Diagnostic codes, a recorded-packet corpus, and the OSC layer so far — VMC semantics are next |
