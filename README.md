...
| [`vrmAdapterVmc`](adapters/liveCapture/vmc) | Plain static CMake library | The first of those leaves: VMC Protocol input, from OSC-over-UDP datagrams to canonical humanoid semantics. Diagnostic codes and a recorded-packet corpus so far — the decoder is next |
