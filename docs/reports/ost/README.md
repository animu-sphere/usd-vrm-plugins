...
| --- | --- | --- | --- | --- |
| 32 | 2026-07-26 | [What a hand-rolled lane for plain libraries costs](32-2026-07-26-v0.20.0-motion-layer-ci-workaround.md) | 0.20.0 | Report 28's P0 is still open, so v0.5.0 hand-authored a lane for the motion layer: ~190 lines, ~120 of them a copy of generated logic, and a second place runtime digests must be re-pinned. Also found the whole-workspace baseline gate had been stale for a release. **Live v0.21.0 asks (consolidated)** |
